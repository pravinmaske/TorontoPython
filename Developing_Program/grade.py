def read_grades(gradefile):
    ...
    them has a blank line, and then lines containing a student number and
    a grade
    ...
    line=gradefile.readline()
    while line !='':
        #Now we have a string cotaining the information
...
def count_grades_range(grades):
    ...
    90-99: 9
    100:   10
    >>>count_grades_range([77.5, 37.5, 0.5, 9.5, 72.5, 100.0, 55.0, 70.0, 79.5])
